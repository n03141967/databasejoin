...
define(['jquery', 'fab/element', 'fab/encoder', 'fab/fabrik', 'fab/autocomplete-bootstrap', './autocompleteMultiselect'],
    function (jQuery, FbElement, Encoder, Fabrik, AutoComplete, autocompletemultiselect) {
    window.FbDatabasejoin = new Class({
        ...
        initialize: function (element, options) {
            ...
            this.init();
            //fconsole(autocomplete-multiselect);
            Fabrik.addEvent('fabrik.autocomplete.selected', function (elementList) {

                let elementRef = document.getElementById(element+'-auto-complete');
                let inputStr = '';
                elementList.forEach(element => {
                    inputStr += element.text + ', ';
                });
                elementRef.value = inputStr;
            });
        },
        ...
        addOption: function (v, l, autoCompleteUpdate) {
            ...
            switch (this.options.displayType) {
                ...
                case 'multilist':
                    ...
                    break;
                case 'auto-complete':
                    fconsole('Debug: auto-complete v')
                    fconsole(v);
