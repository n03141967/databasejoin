...
class PlgFabrik_ElementDatabasejoin extends PlgFabrik_ElementList
{
    ...
    {
        echo '<pre>';
        var_dump('filterValueList_Exact 4');
        echo '</pre>';
        exit();
        if ($this->isJoin()) {
    ...
    {
        echo '<pre>';
        var_dump('addSpaceToEmptyLabels 15');
        echo '</pre>';
        exit();
        foreach ($rows as &$t) {
            if ($t->$txt == '') {
    ...
    {
        echo '<pre>';
        var_dump('buildQueryDescription 21');
        echo '</pre>';
        exit();
        $params = $this->getParams();
    ...
    {
        echo '<pre>';
        var_dump('getAdditionalQueryFields 22');
        echo '</pre>';
        exit();
        return '';
    }
    ...
    {
        echo '<pre>';
        var_dump('getFullLabelOrConcat 25');
        echo '</pre>';
        exit();
        $params = $this->getParams();
        $join = $this->getJoin();
    ...
    {
        echo '<pre>';
        var_dump('getLabelOrConcatVal 26');
        echo '</pre>';
        exit();
        $params = $this->getParams();
        $join = $this->getJoin();
    ...
    {
        echo '<pre>';
        var_dump('renderFrontEndSelect 33');
        echo '</pre>';
        exit();
    ...
    {
        echo '<pre>';
        var_dump('renderReadOnlyTrimOptions 37');
        echo '</pre>';
        exit();
    ...
    {
        echo '<pre>';
        var_dump('renderDropdownList 38');
        echo '</pre>';
        exit();
        $id = $this->getHTMLId($repeatCounter);
    ...
    {
        echo '<pre>';
        var_dump('renderAutoComplete 40');
        echo '</pre>';
        exit();
        $formModel = $this->getFormModel();
        $thisElName = $this->getHTMLName($repeatCounter);
    ...
    {
        echo '<pre>';
        var_dump('renderMultiSelectList 41');
        echo '</pre>';
        exit();
    ...
    {
        echo '<pre>';
        var_dump('renderCheckBoxList 42');
        echo '</pre>';
        exit();
        $id = $this->getHTMLId($repeatCounter);
        $name = $this->getHTMLName($repeatCounter);
    ...
    {
        echo '<pre>';
        var_dump('getFieldDescription 46');
        echo '</pre>';
        ...
        if ((int)$this->id !== 0) {
            ...
            if ($join->get('table_join', '') == '') {
				...
				*/
				...
				/**
                 * Parte que verifica se a linha na tabela fabrik_joins existe e ai ele o cria apartir desse funcionamento.
                 */

                if($params->get('join_many_to_many_relationship') === '1'){
                    echo '<pre>';
                    var_dump('46 - 1 Se o id do elemento foi gerado e o campo table_join esta vazio', $dbName, $joinKey);
                    echo '</pre>';
                    //exit();
                }
            } else {
                ...
                echo '<pre>';
                var_dump('46 - 2 $join->get(table_join) !==\"\" ', $dbName, $joinKey, $params->get('join_many_to_many_relationship'));
                echo '</pre>';
                //exit();
            }
        } else {
            ...
            $joinKey = $params->get('join_key_column');
            echo '<pre>';
            var_dump('46 - 3 o ID do elemento está vazio', $dbName, $joinKey);
            echo '</pre>';
            //exit();
        }
        ...
        try {
            ...
            $fields = $db->loadObjectList();
				echo '<pre>';
                        var_dump('46 - 3 ', $dbName, $joinKey, $field->Type);
                        echo '</pre>';
            if (is_array($fields)) {
    ...
    {
        echo '<pre>';
        var_dump('getFilterCondition 51');
        echo '</pre>';
        exit();
    ...
    {
        echo '<pre>';
        var_dump('getDefaultFilterVal 52');
        echo '</pre>';
        exit();
    ...
    {
        echo '<pre>';
        var_dump('filterHiddenFields 54');
        echo '</pre>';
        exit();
        $params = $this->getParams();
    ...
    {
        echo '<pre>';
        var_dump('filterValueList_All 57');
        echo '</pre>';
        exit();
        if ($this->isJoin()) {
    ...
    {
        echo '<pre>';
        var_dump('getJoinValueColumn 59');
        echo '</pre>';
        exit();
        $join = $this->getJoin();
        $db = FabrikWorker::getDbo();
    ...
    {
        echo '<pre>';
        var_dump('getJoinValueFieldName 60');
        echo '</pre>';
        exit();
        $params = $this->getParams();
    ...
    {
        echo '<pre>';
        var_dump('dataConsideredEmpty 67');
        echo '</pre>';
        exit();
    ...
    {
        echo '<pre>';
        var_dump('elementJavascriptOpts 71');
        echo '</pre>';
        exit();
        $params = $this->getParams();
    ...
    {
        echo '<pre>';
        var_dump('elementJavascriptJoinOpts 73');
        echo '</pre>';
        exit();
        if ($this->isJoin()) {
            $element = $this->getElement();
    ...
    {
          echo '<pre>';
            var_dump('onSave 75', $this->isJoin());
            echo '</pre>';
            //exit();
    ...
    {
        echo '<pre>';
        var_dump('getValidationWatchElements 80');
        echo '</pre>';
        exit();
        $id = $this->getHTMLId($repeatCounter);
        $params = $this->getParams();
    ...
    {
        echo '<pre>';
        var_dump('getDefaultFilterCondition 82');
        echo '</pre>';
        exit();
        return '=';
    }
    ...
    {
        echo '<pre>';
        var_dump('cacheAutoCompleteOptions 83 1');
        echo '</pre>';
        exit();
    ...
    {
        echo '<pre>';
        var_dump('_autocompleteWhere 84');
        echo '</pre>';
        exit();
        $db = FabrikWorker::getDbo();
    ...
    public function isJoin()
    {
        ...
        if (in_array($this->getDisplayType(), array('checkbox', 'multilist'))) {
            $this->estructureRelatioshipManyToMany();
            return true;
        } else {
    ...
    {
        echo '<pre>';
        var_dump('buildQueryElementConcat 88');
        echo '</pre>';
        exit();
        //$join      = $this->getJoinModel()->getJoin();
        $join = $this->getJoin();
    ...
    {
        echo '<pre>';
        var_dump('buildQueryParentKey 89');
        echo '</pre>';
        exit();
    ...
    {
        echo '<pre>';
        var_dump('buildQueryElementConcatId 90');
        echo '</pre>';
        exit();
    ...
    {
        echo '<pre>';
        var_dump('getJoinRepeatCount 92');
        echo '</pre>';
        exit();
        $displayType = $this->getDisplayType();
    ...
    {
        echo '<pre>';
        var_dump('canIncludeInSearchAll 93');
        echo '</pre>';
        exit();
        if ($advancedMode) {
    ...
    {
        echo '<pre>';
        var_dump('multiOptionTargetIds 95');
        echo '</pre>';
        exit();
        $displayType = $this->getDisplayType();
    ...
    {
        echo '<pre>';
        var_dump('getValuesToEncrypt 96');
        echo '</pre>';
        exit();
        $displayType = $this->getDisplayType();
	...
	Retutn
	*/
    private function estructureRelatioshipManyToMany(){
		
        $params = $this->getParams();

        $displayType = $params->get('database_join_display_type');
        $manyToMany = $params->get('join_many_to_many_relationship');
        $tabela = $params->get('join_db_name');

        if(($displayType == 'checkbox' || $displayType == 'multilist') && ($manyToMany === '1')){
            $element = $this->getElement();
            ...
            $query = "SELECT
                        ...
                        relat.list_id,
                        relat.element_id,
                        relat.join_from_table,
                        relat.table_join,
                        relat.table_key,
                        relat.table_join_key,
                        relat.join_type,
                        relat.group_id,
                        relat.params
                        FROM
                        ppufg_fabrik_joins AS relat
                        WHERE
                        relat.element_id = {$elementId}";

            $db->setQuery($query);

            $resultJoins = $db->loadObject();

            if(count($resultJoins) == 1){
                $query = "SELECT
                            rjoins.id,
                            rjoins.list_id,
                            rjoins.element_id,
                            rjoins.join_from_table,
                            rjoins.table_join,
                            rjoins.table_key,
                            rjoins.table_join_key,
                            rjoins.join_type,
                            rjoins.group_id,
                            rjoins.params
                            FROM
                            #__fabrik_joins AS rjoins
                            LEFT JOIN #__fabrik_elements AS element ON rjoins.element_id = element.id
                            WHERE
                            rjoins.join_from_table = '{$tabela}' AND
                            element.`plugin` = 'databasejoin'";

                $db->setQuery($query);

                $resultJoins1 = $db->loadObject();

                if(count($resultJoins1) === 1){
                    try{
                        $db->transactionStart();

                        if($resultJoins->table_join !== $resultJoins1->table_join){

                            echo '<pre>';
                            var_dump('estructureRelatioshipManyToMany');
                            echo '</pre>';
                            //exit();
                            $query = "DROP TABLE {$resultJoins->table_join}";

                            $db->setQuery($query);
                            $db->execute();

                            $query = "UPDATE `#__fabrik_joins`
                                    SET
                                    `table_join` = '{$resultJoins1->table_join}',
                                    `table_key` = '{$resultJoins1->table_join_key}',
                                    `table_join_key` = '{$resultJoins1->table_key}'
                                    WHERE `id` = {$resultJoins->id};";
                        ...
                        JFactory::getApplication()->enqueueMessage(JText::_('Your many to many element repeat was created succefuly.'), 'Message');

                    }catch (Exception $exc){
                        $db->transactionRollback();

                        JFactory::getApplication()->enqueueMessage(JText::_('Something went wrong' . $exc), 'error');
                    }
